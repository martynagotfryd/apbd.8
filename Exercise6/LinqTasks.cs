...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            int maxSal = Emps.Max(e => e.Salary);
            var res = Emps.Where(e => e.Salary == maxSal);
            
            IEnumerable<Emp?> result = res;
            return result;
        }
        ...
        {
            // WHY IT DOESNT WORK??? WHERE TO ADD SELECT
            
            // var a = new { Name = "name", Job = "job" };
            // var b = new { Dname = "name" };
            //
            // var res = Emps.Join(
            //     Depts,
            //     e => e.Deptno,
            ...
            //     (e, d) => new
            //     {
            //         Name = e.Ename, Job = e.Job, Dname = d.Dname
            //     });
            ...
            IEnumerable<object> result = res2;
            return result;
        ...
        {
            // dab
            var res = Emps.GroupBy(e => e.Job).Select(g => new { Praca = g.Key, LiczbaPracownikow = g.Count() });
            
            IEnumerable<object> result = res;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.WithSubordinates().ToList();
